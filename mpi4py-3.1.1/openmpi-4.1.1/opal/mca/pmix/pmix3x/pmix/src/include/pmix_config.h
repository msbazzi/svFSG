...
#define PMIX_CONFIGURE_CLI " \'--disable-man-pages\' \'--disable-debug\' \'--with-pmix-symbol-rename=OPAL_MCA_PMIX3X_\' \'--enable-embedded-mode\' \'--disable-pmix-timing\' \'--without-tests-examples\' \'--disable-pmix-binaries\' \'--disable-pmix-backward-compatibility\' \'--disable-visibility\' \'--enable-embedded-libevent\' '--with-libevent-header=\"opal/mca/event/external/external.h\"' \'--enable-embedded-hwloc\' '--with-hwloc-header=\"opal/mca/hwloc/external/external.h\"' \'--prefix=/usr/local\' \'CFLAGS=-O3 -DNDEBUG  \' \'CPPFLAGS=-I/home/bazzi/repo/svFSG/mpi4py-3.1.1/openmpi-4.1.1 -I/home/bazzi/repo/svFSG/mpi4py-3.1.1/openmpi-4.1.1 -I/home/bazzi/repo/svFSG/mpi4py-3.1.1/openmpi-4.1.1/opal/include -I/home/bazzi/repo/svFSG/mpi4py-3.1.1/openmpi-4.1.1/opal/include    \' \'--cache-file=/dev/null\' \'--srcdir=.\' \'--disable-option-checking\'"

/* Date when PMIx was built */
#define PMIX_CONFIGURE_DATE "2024-06-04T11:46:36"

/* Hostname where PMIx was built */
#define PMIX_CONFIGURE_HOST "heisenberg"

/* User who built PMIx */
#define PMIX_CONFIGURE_USER "bazzi"
...
#define PMIX_PACKAGE_STRING "PMIx bazzi@heisenberg Distribution"
